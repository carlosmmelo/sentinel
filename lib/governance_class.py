...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to xsnd "gobject list" output
    ...
    def xsnd_serialise(self):
        import xsnlib
        return xsnlib.SHIM_serialise_for_xsnd(self.serialise())
