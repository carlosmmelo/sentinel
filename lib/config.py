...
sentinel_cfg = xsnConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_xsnd_proto_version_with_sentinel_ping = 70207


def get_xsn_conf():
    home = os.environ.get('HOME')

    xsn_conf = os.path.join(home, ".xsncore/xsn.conf")
    if sys.platform == 'darwin':
        xsn_conf = os.path.join(home, "Library/Application Support/xsnCore/xsn.conf")

    xsn_conf = sentinel_cfg.get('xsn_conf', xsn_conf)
